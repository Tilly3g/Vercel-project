...
I love the sound of this, digging through code to find bugs and, when I can, resolve them is one of the main reasons I transitioned in to technical support.
...
Anything that will help improve a customers experience, either by making it easier for them to find a resolve a problem on their own or letting them know what we need from them in order to help them as fast as possible.

- Help train and onboard new support teammates

I'm a people person so working closely with new teammates is something I really enjoy. I also find that not only does it help them, but it can be invaluable to me as well, for example if we take on a ticket together that I've not come accross either.
...
This is super important and I'm more then happy to help out when needed, however, my passion lies in the troubleshooting and bugfixing, which is why this has made it on to this list
